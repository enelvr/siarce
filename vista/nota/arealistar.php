...
<a href="sircarch.php?modulo=7&accion=1"><span>Nueva Archivo<img src="libreria/plus-small.gif" width="12" height="9"/></span></a>';
}
elseif(isset($_GET['area'])) {echo '

<a href="sircarch.php?modulo=7&accion=1&area='.$_GET[area].'"><span>Nueva Nota<img src="libreria/plus-small.gif" width="12" height="9"/></span></a>';
}
...
{$ar=$_SESSION["privilegios"];
echo'
<input type="hidden" class="search-query" name="tipoubicacion_id" value="'.$ar.'">
	<input type="hidden" name="modulo"  value="7">
        <input type="hidden" name="accion"  value="6">
';}
else
{echo'<input type="hidden" class="search-query" name="tipoubicacion_id" value="'.$ar.'">
	<input type="hidden" name="modulo"  value="7">
        <input type="hidden" name="accion"  value="6">';}
?>
...
<?php foreach($notaremision as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="sircarch.php?modulo=7&accion=4&codigo=<?php echo $item[codigo];?>&area=<?php echo $_GET[area];?>"><img src="public/img/mostrar.png" width="16" height="16" alt="mostrar" /></a>
                                        <a href="sircarch.php?modulo=7&accion=8&codigo=<?php echo $item[codigo];?>&area=<?php echo $_GET[area];?>"><img src="libreria/pencil.gif" width="16" height="16" alt="edit" />
                                    </td>
                                </tr> <?php endforeach?>
                                 </tbody>               </table>
