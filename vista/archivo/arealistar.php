...
<input type="hidden" class="search-query" name="arce" value="'.$ar.'">
	<input type="hidden" name="modulo"  value="6">
        <input type="hidden" name="accion"  value="7">
';}
else
{echo'<input type="hidden" class="search-query" name="arce" value="'.$ar.'">
	<input type="hidden" name="modulo"  value="6">
        <input type="hidden" name="accion"  value="7">';}
?>
...
?></td>
                                    ...
                                    <td>
                                        <a href="sircarch.php?modulo=6&accion=4&codigo=<?php echo $item[n];?>&area=<?php echo $_GET[area];?>"><img src="public/img/mostrar.png" width="16" height="16" alt="mostrar" /></a>
                                        <a href="sircarch.php?modulo=6&accion=10&codigo=<?php echo $item[n];?>&area=<?php echo $_GET[area];?>"><img src="libreria/pencil.gif" width="16" height="16" alt="edit" /></a>
                                        <a href="upload/<?php echo $item[url]; ?>" target="_blank"><img src="public/img/des.png" width="16" height="16" alt="descargar" /></a>
                                    </td>
                                </tr> <?php endforeach?>
                                 </tbody>               </table>
