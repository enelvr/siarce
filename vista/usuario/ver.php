...
<p class="text-center"><!--<a class="btn btn-primary" href="sircarch.php?modulo=5&accion=3">Listar</a>||--> 
 <a class="btn btn-primary" href="sircarch.php?modulo=5&accion=13&id=<?php echo $id;?>">Editar</a></p>
